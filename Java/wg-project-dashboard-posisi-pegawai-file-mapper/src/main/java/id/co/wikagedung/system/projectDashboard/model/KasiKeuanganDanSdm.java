...
public class KasiKeuanganDanSdm {
	...
	public KasiKeuanganDanSdm() {
	}

	public KasiKeuanganDanSdm(String id, String namaProyek, String periode,
			String nama, String nip, String statusPendidikan) {
		this.id = id;

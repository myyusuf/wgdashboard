...
public class StaffAkuntansiDanKeuangan {
	...
	public StaffAkuntansiDanKeuangan() {
	}

	public StaffAkuntansiDanKeuangan(String id, String namaProyek,
			String periode, String nama, String nip, String statusPendidikan) {
		this.id = id;

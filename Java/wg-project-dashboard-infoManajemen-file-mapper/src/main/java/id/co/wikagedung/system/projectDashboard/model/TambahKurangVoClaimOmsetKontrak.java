...
public class TambahKurangVoClaimOmsetKontrak {
	...
	public TambahKurangVoClaimOmsetKontrak() {
	}

	public TambahKurangVoClaimOmsetKontrak(String id, String namaProyek,
	...
	public String toString() {
		return "TambahKurangVOClaim [id=" + id + ", namaProyek=" + namaProyek

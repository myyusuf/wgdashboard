...
public class TotalBuPusatRisikoPphFinal {
	...
	public TotalBuPusatRisikoPphFinal() {
	}

	public TotalBuPusatRisikoPphFinal(String id, String namaProyek,
	...
	public String toString() {
		return "TotalBuPusatRisikoPphFinal [id=" + id + ", namaProyek="

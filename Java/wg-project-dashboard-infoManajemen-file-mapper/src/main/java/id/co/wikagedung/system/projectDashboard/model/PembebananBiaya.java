...
public class PembebananBiaya {
	...
	public PembebananBiaya() {
	}

	public PembebananBiaya(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "PembebananBiaya [id=" + id + ", namaProyek=" + namaProyek

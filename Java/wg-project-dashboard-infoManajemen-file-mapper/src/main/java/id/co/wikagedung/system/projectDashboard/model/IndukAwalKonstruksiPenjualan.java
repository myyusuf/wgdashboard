...
public class IndukAwalKonstruksiPenjualan {
	...
	public IndukAwalKonstruksiPenjualan() {
	}

	public IndukAwalKonstruksiPenjualan(String id, String namaProyek,
	...
	public String toString() {
		return "IndukAwalKonstruksiPenjualan [id=" + id + ", namaProyek="

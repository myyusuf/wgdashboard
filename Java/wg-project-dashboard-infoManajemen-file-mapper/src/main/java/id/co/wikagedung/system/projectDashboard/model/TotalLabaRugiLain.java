...
public class TotalLabaRugiLain {
	...
	public TotalLabaRugiLain() {
	}

	public TotalLabaRugiLain(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "TotalLabaRugiLain [id=" + id + ", namaProyek=" + namaProyek

...
public class ProsentaseTerhadapProduksi {
	...
	public ProsentaseTerhadapProduksi() {
	}

	public ProsentaseTerhadapProduksi(String id, String namaProyek,
	...
	public String toString() {
		return "ProsentaseTerhadapProduksi [id=" + id + ", namaProyek="

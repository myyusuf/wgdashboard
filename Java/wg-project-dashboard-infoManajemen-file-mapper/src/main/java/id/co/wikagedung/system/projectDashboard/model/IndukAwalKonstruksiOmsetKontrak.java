...
public class IndukAwalKonstruksiOmsetKontrak {
	...
	public IndukAwalKonstruksiOmsetKontrak() {
	}

	public IndukAwalKonstruksiOmsetKontrak(String id, String namaProyek,
	...
	public String toString() {
		return "IndukAwalKonstruksi [id=" + id + ", namaProyek=" + namaProyek

...
public class SurplusDefisit {
	...
	public SurplusDefisit() {
	}

	public SurplusDefisit(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "SurplusDefisit [id=" + id + ", namaProyek=" + namaProyek

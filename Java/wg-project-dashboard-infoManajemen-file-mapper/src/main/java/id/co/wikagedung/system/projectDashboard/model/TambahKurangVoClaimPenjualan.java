...
public class TambahKurangVoClaimPenjualan {
	...
	public TambahKurangVoClaimPenjualan() {
	}

	public TambahKurangVoClaimPenjualan(String id, String namaProyek,
	...
	public String toString() {
		return "TambahJualVoClaimPenjualan [id=" + id + ", namaProyek="

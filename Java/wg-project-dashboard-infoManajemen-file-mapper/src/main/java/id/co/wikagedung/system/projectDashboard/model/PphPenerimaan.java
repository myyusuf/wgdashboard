...
public class PphPenerimaan {
	...
	public PphPenerimaan() {
	}

	public PphPenerimaan(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "PphPenerimaan [id=" + id + ", namaProyek=" + namaProyek

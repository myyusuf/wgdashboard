...
public class BiayaTakLangsung {
	...
	public BiayaTakLangsung() {
	}

	public BiayaTakLangsung(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "BiayaTakLangsung [id=" + id + ", namaProyek=" + namaProyek

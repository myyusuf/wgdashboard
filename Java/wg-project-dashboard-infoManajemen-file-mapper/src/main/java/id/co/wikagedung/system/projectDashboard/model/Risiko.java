...
public class Risiko {
	...
	public Risiko(String id, String namaProyek, String periode, Double rkpAwal,
			Double rencanaSampaiBulanIni, Double realisasiSampaiBulanLalu,
			Double realisasiBulanIni, Double realisasiSampaiBulanIni,
			Double proyeksi) {
		this.id = id;
	...
	public String toString() {
		return "Risiko [id=" + id + ", namaProyek=" + namaProyek + ", periode="
				+ periode + ", rkpAwal=" + rkpAwal + ", rencanaSampaiBulanIni="
				+ rencanaSampaiBulanIni + ", realisasiSampaiBulanLalu="
				+ realisasiSampaiBulanLalu + ", realisasiBulanIni="
				+ realisasiBulanIni + ", realisasiSampaiBulanIni="
				+ realisasiSampaiBulanIni + ", proyeksi=" + proyeksi + "]";
	}

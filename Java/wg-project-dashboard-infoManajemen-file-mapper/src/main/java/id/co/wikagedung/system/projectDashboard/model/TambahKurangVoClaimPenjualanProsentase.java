...
public class TambahKurangVoClaimPenjualanProsentase {
	...
	public TambahKurangVoClaimPenjualanProsentase() {
	}

	public TambahKurangVoClaimPenjualanProsentase(String id, String namaProyek,
			String periode, Integer rkpAwal, Integer rencanaSampaiBulanIni,
	...
	public String toString() {
		return "TambahKurangVOClaimProsentase [id=" + id + ", namaProyek="
				+ namaProyek + ", periode=" + periode + ", rkpAwal=" + rkpAwal

...
public class IndukAwalKonstruksiPenjualanProsentase {
	...
	public IndukAwalKonstruksiPenjualanProsentase() {
	}

	public IndukAwalKonstruksiPenjualanProsentase(String id, String namaProyek,
	...
	public String toString() {
		return "IndukAwalKonstruksiProsentase [id=" + id + ", namaProyek="

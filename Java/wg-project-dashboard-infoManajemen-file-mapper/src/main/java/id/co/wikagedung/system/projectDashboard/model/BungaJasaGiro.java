...
public class BungaJasaGiro {
	...
	public BungaJasaGiro() {
	}

	public BungaJasaGiro(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "BungaJasaGiro [id=" + id + ", namaProyek=" + namaProyek

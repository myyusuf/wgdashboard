...
public class BiayaLangsung {
	...
	public BiayaLangsung() {
	}

	public BiayaLangsung(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "BiayaLangsung [id=" + id + ", namaProyek=" + namaProyek

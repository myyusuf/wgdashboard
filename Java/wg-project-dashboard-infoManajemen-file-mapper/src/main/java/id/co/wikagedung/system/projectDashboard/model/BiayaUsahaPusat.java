...
public class BiayaUsahaPusat {
	...
	public BiayaUsahaPusat() {
	}

	public BiayaUsahaPusat(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "BiayaUsahaPusat [id=" + id + ", namaProyek=" + namaProyek

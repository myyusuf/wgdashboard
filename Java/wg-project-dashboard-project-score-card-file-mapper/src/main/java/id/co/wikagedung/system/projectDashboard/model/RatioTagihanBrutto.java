...
public class RatioTagihanBrutto {
	...
	public RatioTagihanBrutto() {
	}

	public RatioTagihanBrutto(String id, String namaProyek, String periode,
			Double targetRkp, Double targetPeriodikRencana,
			Double targetPeriodikRealisasi, Double targetPeriodikProsentase,
			Double nilai, Double bobotKpi, Double scoreRencana,
			Double scoreRealisasi, String upjFungsi, String level) {
		this.id = id;

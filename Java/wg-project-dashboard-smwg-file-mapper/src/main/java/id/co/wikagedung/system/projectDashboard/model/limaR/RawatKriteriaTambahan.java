...
public class RawatKriteriaTambahan {
	...
	public RawatKriteriaTambahan() {
	}

	public RawatKriteriaTambahan(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RawatKriteriaTambahan [id=" + id + ", namaProyek=" + namaProyek

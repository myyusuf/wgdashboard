...
public class RapiKriteriaStandar {
	...
	public RapiKriteriaStandar() {
	}

	public RapiKriteriaStandar(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RapiKriteriaStandar [id=" + id + ", namaProyek=" + namaProyek

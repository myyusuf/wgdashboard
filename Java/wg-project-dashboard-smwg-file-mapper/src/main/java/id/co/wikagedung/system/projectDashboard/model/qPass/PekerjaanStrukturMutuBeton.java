...
public class PekerjaanStrukturMutuBeton {
	...
	public PekerjaanStrukturMutuBeton() {
	}

	public PekerjaanStrukturMutuBeton(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanStrukturMutuBeton [id=" + id + ", namaProyek="

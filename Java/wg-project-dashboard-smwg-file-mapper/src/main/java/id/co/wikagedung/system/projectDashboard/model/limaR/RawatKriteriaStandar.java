...
public class RawatKriteriaStandar {
	...
	public RawatKriteriaStandar() {
	}

	public RawatKriteriaStandar(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RawatKriteriaStandar [id=" + id + ", namaProyek=" + namaProyek

...
public class PekerjaanArsitekturInternalFinishes {
	...
	public PekerjaanArsitekturInternalFinishes() {
	}

	public PekerjaanArsitekturInternalFinishes(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanArsitekturInternalFinishes [id=" + id
				+ ", namaProyek=" + namaProyek + ", periode=" + periode

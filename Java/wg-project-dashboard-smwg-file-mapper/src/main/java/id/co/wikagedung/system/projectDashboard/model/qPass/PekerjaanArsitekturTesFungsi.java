...
public class PekerjaanArsitekturTesFungsi {
	...
	public PekerjaanArsitekturTesFungsi() {
	}

	public PekerjaanArsitekturTesFungsi(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanArsitekturTesFungsi [id=" + id + ", namaProyek="

...
public class PekerjaanStrukturBesi {
	...
	public PekerjaanStrukturBesi() {
	}

	public PekerjaanStrukturBesi(String id, String namaProyek, String periode,
			Double jumlahSampelRencana,
	...
	public String toString() {
		return "PekerjaanStrukturBesi [id=" + id + ", namaProyek=" + namaProyek
				+ ", periode=" + periode + ", jumlahSampelRencana="
				+ jumlahSampelRencana + ", jumlahSampeSampaiBulanIniRealisasi="

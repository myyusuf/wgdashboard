...
public class PekerjaanArsitekturEksternalWork {
	...
	public PekerjaanArsitekturEksternalWork() {
	}

	public PekerjaanArsitekturEksternalWork(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanArsitekturEksternalWork [id=" + id + ", namaProyek="

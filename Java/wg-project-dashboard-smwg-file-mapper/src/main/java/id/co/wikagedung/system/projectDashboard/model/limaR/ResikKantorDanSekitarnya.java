...
public class ResikKantorDanSekitarnya {
	...
	public ResikKantorDanSekitarnya() {
	}

	public ResikKantorDanSekitarnya(String id, String namaProyek,
			String periode, Double kantorTempatKerja,
	...
	public String toString() {
		return "ResikKantorDanSekitarnya [id=" + id + ", namaProyek="
				+ namaProyek + ", periode=" + periode + ", kantorTempatKerja="

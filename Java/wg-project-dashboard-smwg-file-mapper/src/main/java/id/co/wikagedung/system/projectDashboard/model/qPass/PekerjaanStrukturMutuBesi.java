...
public class PekerjaanStrukturMutuBesi {
	...
	public PekerjaanStrukturMutuBesi() {
	}

	public PekerjaanStrukturMutuBesi(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanStrukturMutuBesi [id=" + id + ", namaProyek="

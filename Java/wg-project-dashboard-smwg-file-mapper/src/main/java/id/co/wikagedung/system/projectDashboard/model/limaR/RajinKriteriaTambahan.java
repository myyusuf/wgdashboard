...
public class RajinKriteriaTambahan {
	...
	public RajinKriteriaTambahan() {
	}

	public RajinKriteriaTambahan(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RajinKriteriaTambahan [id=" + id + ", namaProyek=" + namaProyek

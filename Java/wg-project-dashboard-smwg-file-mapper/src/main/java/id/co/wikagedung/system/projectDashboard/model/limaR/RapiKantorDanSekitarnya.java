...
public class RapiKantorDanSekitarnya {
	...
	public RapiKantorDanSekitarnya() {
	}

	public RapiKantorDanSekitarnya(String id, String namaProyek,
	...
	public String toString() {
		return "RapiKantorDanSekitarnya [id=" + id + ", namaProyek="

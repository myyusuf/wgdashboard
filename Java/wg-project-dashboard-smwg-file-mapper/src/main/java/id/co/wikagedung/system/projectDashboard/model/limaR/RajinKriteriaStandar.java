...
public class RajinKriteriaStandar {
	...
	public RajinKriteriaStandar() {
	}

	public RajinKriteriaStandar(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RajinKriteriaStandar [id=" + id + ", namaProyek=" + namaProyek

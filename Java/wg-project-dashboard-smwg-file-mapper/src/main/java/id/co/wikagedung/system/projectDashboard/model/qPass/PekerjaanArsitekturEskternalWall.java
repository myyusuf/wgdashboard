...
public class PekerjaanArsitekturEskternalWall {
	...
	public PekerjaanArsitekturEskternalWall() {
	}

	public PekerjaanArsitekturEskternalWall(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanArsitekturEskternalWall [id=" + id + ", namaProyek="

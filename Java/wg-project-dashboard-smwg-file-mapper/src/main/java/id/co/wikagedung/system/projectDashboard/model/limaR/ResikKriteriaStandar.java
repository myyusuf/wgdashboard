...
public class ResikKriteriaStandar {
	...
	public ResikKriteriaStandar() {
	}

	public ResikKriteriaStandar(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "ResikKriteriaStandar [id=" + id + ", namaProyek=" + namaProyek

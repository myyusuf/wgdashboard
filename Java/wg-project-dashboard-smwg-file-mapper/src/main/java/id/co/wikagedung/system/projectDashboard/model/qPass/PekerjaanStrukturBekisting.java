...
public class PekerjaanStrukturBekisting {
	...
	public PekerjaanStrukturBekisting() {
	}

	public PekerjaanStrukturBekisting(String id, String namaProyek,
	...
	public String toString() {
		return "PekerjaanStrukturBekisting [id=" + id + ", namaProyek="

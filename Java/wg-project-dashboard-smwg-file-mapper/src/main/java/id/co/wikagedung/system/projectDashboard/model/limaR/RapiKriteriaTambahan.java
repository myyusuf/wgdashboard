...
public class RapiKriteriaTambahan {
	...
	public RapiKriteriaTambahan() {
	}

	public RapiKriteriaTambahan(String id, String namaProyek, String periode,
	...
	public String toString() {
		return "RapiKriteriaTambahan [id=" + id + ", namaProyek=" + namaProyek
